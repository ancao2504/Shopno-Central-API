...
if (array_key_exists("BookingID",$_GET)){
  ...
  $message = <<<EOM
    ...
    <soapenv:Header/>
		<soapenv:Body>
            <UniversalRecordCancelReq xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                xmlns:xsd="http://www.w3.org/2001/XMLSchema" TraceId="FFI-KayesFahim" TargetBranch="P4218912"
                UniversalRecordLocatorCode="$BookingID" Version="0" xmlns="http://www.travelport.com/schema/universal_v51_0">
