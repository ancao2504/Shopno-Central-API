			...
			foreach($itineraryGroups as $itineraries){
				...
				if($adult > 0 && $child > 0 && $infants > 0){
					...
					$PriceBreakDown = array("0" =>
												array("BaseFare"=> "$adultbaseFareAmount",
												"Tax"=> "$adultTotalTaxAmount",
												"PaxCount"=> $adult,
												"PaxType"=> "ADT")
												,
												"1" =>
												array("BaseFare"=> "$childbaseFareAmount",
												"Tax"=> "$adultTotalTaxAmount",
												"PaxCount"=> $child,
												"PaxType"=> "CNN"),
												"2" =>
												array("BaseFare"=> "$infantbaseFareAmount",
				...
				$fareComponents = $passengerInfo['fareComponents'];
					...
					if($sgCount1 == 1){
						...
						$City1Data = array("0" =>
												array("marketingcareer"=> "$city1markettingCarrier",
					...
					if($sgCount2 == 1){
						...
						$City2Data = array("0" =>
												array("marketingcareer"=> "$city2markettingCarrier",
					...
					if($sgCount3 == 1){
						...
						$City3Data = array("0" =>
												array("marketingcareer"=> "$city3markettingCarrier",
					...
					if($sgCount4 == 1){
						...
						$City4Data = array("0" =>
												array("marketingcareer"=> "$city4markettingCarrier",
