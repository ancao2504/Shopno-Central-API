...
if (array_key_exists("email", $_GET)) {
  ...
  if (!empty($row)) {
    ...
    $link = "https://www.shopnotour.com/resetpassword/$encryption";

    $sql = "INSERT INTO `forgetpassword`(`userId`, `email`, `link`, `isClick`, `expire`)
                         VALUES ('$userId','$email','$encryption','0','36000')";
    ...
    if ($conn->query($sql) === TRUE) {
      ...
      sendToUser($subject, $message, $userId, $header, $property, $data);
