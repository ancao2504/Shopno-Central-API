...
if(array_key_exists("journeyfrom",$_GET) && array_key_exists("journeyto",$_GET) && array_key_exists("departuredate",$_GET) &&
 	array_key_exists("returndate",$_GET) && array_key_exists("adult",$_GET) && (array_key_exists("child",$_GET) && array_key_exists("infant",$_GET) && array_key_exists("country",$_GET))){
		...
		if(isset($result['groupedItineraryResponse']['statistics']['itineraryCount']) && $result['groupedItineraryResponse']['statistics']['itineraryCount'] > 0){
			...
			foreach($flightListSabre as $var){
                ...
                if($checker == 1){
                    ...
                    $Commission =str_replace(',','', number_format($totalFare - $AgentPrice,2)); 
                }else{
	...
	$FlyhubToken  = $TokenJson['TokenId'];
		...
		foreach($FlightListFlyHub as $flight){
			...
			if($segments == 2){
				...
				if(isset($flight['segments'][2]['baggageDetails'][0]['Checkin'])){				
					$goBaggage2 = $flight['segments'][2]['baggageDetails'][0]['Checkin'];
				} else {
					$goBaggage2 = 0;
				}
				...
				if(isset($flight['segments'][3]['baggageDetails'][0]['Checkin'])){				
					$backBaggage = $flight['segments'][3]['baggageDetails'][0]['Checkin'];
				} else {
					$backBaggage = 0;
				}
				...
				if(isset($flight['segments'][4]['baggageDetails'][0]['Checkin'])){				
				...
				if(isset($flight['segments'][5]['baggageDetails'][0]['Checkin'])){				
									...
									array("0" =>
											...
											array("marketingcareer"=> "$goOperatingCarrier1",
												...
												"marketingflight"=> "$goFlightNumber1",
													...
													"seat"=> "$Availabilty"),
											"2" =>
												array("marketingcareer"=> "$goOperatingCarrier2",
									...
									"back" => array("0" =>
													...
													array("marketingcareer"=> "$backOperatingCarrier1",
														...
														"marketingflight"=> "$backFlightNumber1",
															...
															"seat"=> "$Availabilty"),
													"2" =>
														array("marketingcareer"=> "$backOperatingCarrier2",
