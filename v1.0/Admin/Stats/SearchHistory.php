...
if (array_key_exists("all", $_GET)) {
    ...
    //TODAY STATS
    $TodaySearch = $conn->query("SELECT * FROM search_history where searchTime>= CURRENT_DATE ORDER BY searchTime DESC")->num_rows;
    $TodayOnewaySearch = $conn->query("SELECT * FROM search_history where searchtype ='oneway' AND searchTime>= CURRENT_DATE ORDER BY searchTime DESC")->num_rows;
    $TodayReturnSearch = $conn->query("SELECT * FROM search_history where searchtype ='return' AND searchTime>= CURRENT_DATE ORDER BY searchTime DESC")->num_rows;
...
//             search_history.agentId ORDER BY Search DESC")->fetch_all(MYSQLI_ASSOC));
    ...
    $Today['agentwise'] = $TodayAgentwise;
