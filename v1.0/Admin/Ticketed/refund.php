        ...
        if ($status == 'Refund In Processing') {
         ...
         VALUES ('$agentId','$refundAmount','$newBalance','$bookingId','Refunded Money $TicketId Ticket Invoice $Type Air Ticket $Route - $Airlines was Requested By $refundrequestedBy','$refundId','$actionBy','$createdTime')");
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                $subject = $header = "Booking Refund Request Accepted";
                $property = "Booking ID: ";
                $data = $bookingId;
                $adminMessage = "Our Booking Refund Request has been Accepted.";
                $agentMessage = " Your Booking Refund Request has been Accepted.";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($conn->query($sql) === true) {
            ...
            if ($conn->query($sqlBooking) === true) {
                ...
                $property = "Booking ID: ";
                $data = $bookingId;
                $adminMessage = "Our Booking Refund Request has been Cancelled.";
