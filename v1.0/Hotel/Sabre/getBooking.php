...
if (array_key_exists("agentId", $_GET) && array_key_exists("bookingId", $_GET) ) {
    $agentId = $_GET['agentId'];
    $bookingId = $_GET['bookingId'];
    $query = "SELECT * FROM `hotel_booking` WHERE `agentId` = '$agentId' AND `bookingId` = '$bookingId'";
    ...
    $userId = $_GET['userId'];
    $bookingId = $_GET['bookingId'];
    $query = "SELECT * FROM `hotel_booking` WHERE `userId` = '$userId' AND `bookingId` = '$bookingId'";
    $result = $conn->query($query);
