...
if (array_key_exists("agentId", $_GET) && array_key_exists("page", $_GET)) {
  ...
  $sql = "SELECT * FROM `passengers` where agentId='$agentId' ORDER BY Id DESC LIMIT $page_first_result,$result_per_page";
  $totalData = $conn->query("SELECT * FROM `passengers` where agentId='$agentId'")->num_rows;
