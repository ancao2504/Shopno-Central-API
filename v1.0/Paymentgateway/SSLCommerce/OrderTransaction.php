...
class OrderTransaction
{
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        if (array_key_exists("agentId", $post_data)) {
            ...
            $sql = "INSERT INTO orders (userId, name, email, phone, amount, address, status, transaction_id,currency, operator)
            VALUES ('$userId','$name', '$email', '$phone','$transaction_amount','$address','Pending', '$transaction_id','$currency', 'SSLCOMMERZ')";
        }
