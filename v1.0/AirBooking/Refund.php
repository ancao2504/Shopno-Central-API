    ...
    Ticket Refund 
              ...
              <tr>
                <td
                  ...
                  "
                >
                Dear '.$companyname.', You has been Request for Refund a Ticket. Thank you for stay connected with Flyway International.
        </td>     </tr>
...
';
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('refund@flyfarint.com', 'Flyway International');
                    $mail->addAddress("$agentEmail", "AgentId : $agentId");
                    $mail->addCC('otaoperation@flyfarint.com');
                    
                    $mail->isHTML(true);                                  
                    $mail->Subject = "Refund Request Confirmation - $companyname";
                    $mail->Body    = $agentMail;
                    if(!$mail->Send()) {
...
Ticket Refund 
          ...
          <tr>
            <td
              ...
              "
            >
            Dear Flyway International, We are Requested for Void a Ticket.   
          </td>   
          </tr>
...
';
                ...
                try {
                    ...
                    //Recipients
                    $mail1->setFrom('refund@flyfarint.com', 'Flyway International');
                     $mail1->addAddress("otaoperation@flyfarint.com", "Refund Ticket Request");
                    
                    
                    $mail1->isHTML(true);                                  
                    $mail1->Subject = "New Ticket Refund Request by - $companyname";
