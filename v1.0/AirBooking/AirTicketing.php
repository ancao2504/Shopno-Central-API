    ...
    $bonusMessage = "";
        ...
        if($lastAmount >= $netCost){
           $newBalance = $lastAmount - $netCost;
            ...
            $newBalance = $lastAmount - $netCost;
            $creditRemain = $creditBalance - ($netCost - $lastAmount);      
            $conn->query("UPDATE `agent` SET `credit`='$creditRemain' where agentId='$agentId'");
        ...
        VALUES ('$agentId','$netCost','$newBalance','$bookingId','$Type Air Ticket $Route - $Airlines By $IssueBy $bonusMessage','$bookingId','','$createdTime')";
