...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($conn->query($sql) === TRUE) {
    ...
    $subject = $header = "New Booking Void Request";
    $property = "Booking ID: ";
    $data = $bookingId;
    $adminMessage = "We have placed a new Booking Void Request.";
    $agentMessage = "Your Booking Void Request has been placed please wait for a while.";
