...
if ($row['status']=='Reissue In Processing') {
    $AgentId = $row['agentId'];
                ...
                >
                  <tr>
                    <td
                      ...
                      "
                    >
                    Delay Service Alert for Pending Reissue
                    </td>
                  </tr>
...
';
        ...
        try {
            ...
            //Recipients
            $mail1->setFrom('warning@b2b.flyfarint.com', 'Reissue Approval Alert');
            $mail1->addAddress("otaoperation@flyfarint.com", "Fly Far International");
            $mail1->addCC('habib@flyfarint.com');


            $mail1->isHTML(true);
            $mail1->Subject = "$RemainingTime Reissue Request Pending Alert $BookingId";
