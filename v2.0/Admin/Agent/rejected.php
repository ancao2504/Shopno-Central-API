...
if (authorization($conn) == true){
          ...
          >
            ...
            <tr>
              <td
                ...
                "
              >
                        Dear '.$companyname.' Thank you for registering the agent account with fly far international.
              </td>
            </tr>
            ...
            <tr>
              <td
                ...
                "
              >
              Our team reviewed your credentials, but there was a issue with your credentials, consequently your agent request was rejected.
              </td>
            </tr>
                  ...
                  >
                    <tr>
                      <td
                        ...
                        "
                      >
                      Agent request Cancel '.$companyname.'
                    ...
                    <tr>
                      <td
                        ...
                        "
                      >
                      Dear Concern, your team reviewed our information, but there might be some issue with our registration information, consequently our agent request was rejected.
                      </td>
                    </tr>
                      ...
                      <td
                        ...
                        "
                      >
                      Agent request cancelled by: <span style="color: #003566">'.$actionBy.'</span>
                      </td>
                    </tr>
  ...
  ';
          ...
          try {
                ...
                $mail1->isHTML(true);                                  
                $mail1->Subject = "New Agent Request Rejected by - $companyname";
