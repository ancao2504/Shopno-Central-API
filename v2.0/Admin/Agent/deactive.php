...
if (authorization($conn) == true){    
          ...
          >
            ...
            <tr>
              <td
                ...
                "
              >
                        Dear '.$companyname.' Your Fly Far International Agent Account is temporary Deactivate.
            ...
            <tr>
              <td
                ...
                "
              >
  Please Contact with us to Re-activate your agent account.
              </td>
            </tr>
  ...
  ';
          ...
          try {
              ...
              $mail->isHTML(true);                                  
              $mail->Subject = "Agent Deactivate - $companyname";
              $mail->Body    = $htmlBody;
                  ...
                  >
                    <tr>
                      <td
                        ...
                        "
                      >
                      Agent request Deactivate '.$companyname.'
                    ...
                    <tr>
                      <td
                        ...
                        "
                      >
                      Dear Concern, your team just deactivate our Fly Far International Agent account.
                      </td>
                    </tr>
                      ...
                      Agent request deactivate by: <span style="color: #003566">'.$actionBy.'</span>
                      </td>
                    </tr>
  ...
  ';
          ...
          try {
                ...
                $mail1->isHTML(true);                                  
                $mail1->Subject = "New Agent Deactivate by - $companyname";
      ...
      $data = $conn->query("SELECT * FROM agent WHERE status = 'deactive'")->fetch_all(MYSQLI_ASSOC);
