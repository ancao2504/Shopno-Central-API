...
if (authorization($conn) == true){  
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $LossReason = str_replace("'", "''",$_POST['lossreason']);
      ...
      $vendorcomm = $_POST['vendorcommission'];
      $losscom = $_POST['losscommission'];
      ...
      if ($status == "Ticketed") {
        ...
        echo json_encode($response);
          ...
          $comissionvalue = $bookingdata['comissionvalue'];
          $gds = $bookingdata['gds'];
          $pnr = $bookingdata['pnr'];
                    ...
                    <html lang="en">
                      ...
                      <body>
                        ...
                        <td
                          ...
                          "
                        >
                        Airlines PNR: <span style="color: #dc143c">' . $AirlinesPNR . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                          ...
                          "
                        >
                        GDS PNR: <span style="color: #dc143c">' . $gdsPNR . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                          ...
                          "
                        >
                        GDS: <span style="color: #dc143c">' . $system . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                          ...
                          "
                        >
                        Agency ID: <span style="color: #dc143c">' . $agentId . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                          ...
                          "
                        >
                        Agency Name: <span style="color: #dc143c">' . $companyName . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                          ...
                          "
                        >
                      Agent Name: <span style="color: #dc143c">' . $agentName . '</span>
                        </td>
                      </tr>
                        <tr>
                        <td
                        ...
                        Ticketed By: <span style="color: #dc143c">' . $companyName . '</span>
                              ...
                              <td
                                ...
                                "
                              >
                                Destination: <span style="color: #dc143c">' . $Route . ' - ' . $From . ','.$tripType.'</span>
                              </td>
                            </tr>
                              ...
                              <td
                                ...
                                "
                              >
                                Total Pax:  <span style="color: #dc143c">' . $Pax . '</span>
                              </td>
                            </tr>
                                                                    <tr>
                              <td
                                ...
                                "
                              >
                                GDS Segment:  <span style="color: #dc143c">' . $gdsSegment . '</span>
                              </td>
                            </tr>
                            ...
                            <td
                              ...
                              "
                            >
                            Client Commission:  <span style="color: #dc143c"> ' . $comissionvalue . '
                </span>
                            </td>
                          </tr>
                              <tr>
                              <td
                                ...
                                "
                              >
                              Client Invoice:  <span style="color: #dc143c"> ' . $netCost . ' BDT
                  </span>
                              </td>
                            </tr>
                              <tr>
                              <td
                                ...
                                "
                              >
                              Vendor Invoice:  <span style="color: #dc143c"> ' . $vendorinvioce . ' BDT
                  </span>
                              </td>
                            </tr>
                            ...
                            <td
                              ...
                              "
                            >
                            Vendor Commission:  <span style="color: #dc143c"> ' . $vendorcomm . ' BDT
                </span>
                            </td>
                          </tr>
                            ...
                            <td
                              ...
                              "
                            >
                            Commission Diff:  <span style="color: #dc143c"> ' . $losscom . ' BDT
                </span>
                            </td>
                          </tr>
                            ...
                            <td
                              ...
                              "
                            >
                            Loss Amount:  <span style="color: #dc143c"> ' . $lossAmount . ' BDT
                </span>
                            </td>
                          </tr>
                            <tr>
                            <td
                              ...
                              "
                            >
                            Reason:  <span style="color: #dc143c"> ' . $LossReason . '
                </span>
                            </td>
                          </tr>
