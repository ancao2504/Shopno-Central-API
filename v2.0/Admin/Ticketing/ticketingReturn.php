...
if (authorization($conn) == true){  
    ...
    if($status == "Issue In Processing"){
          ...
          if(!empty($staffrow2)){
            $staffName = $staffrow2['name'];
              ...
              air ticket booking issue request has been on process at $DateTime. Thank you
                again for booking with Fly Far International";	
                
                $OwnerMessage = "Dear Fly Far International, Our staff $staffName has been 
            ...
            $OwnerMessage = "Dear Fly Far International, We have been 
            requested for $Route $Type on $Airlines, air ticket which has been issue in
      ...
      $sql1 = mysqli_query($conn,"SELECT lastAmount FROM `agent_ledger` where agentId = '$agentId' 
          ...
          if(!empty($subagentrow1)){
              $lastAmount = $subagentrow1['lastAmount'];							
          }else{
            $lastAmount = 0;
          }

          $sanewBalance = $lastAmount + $subagentCost;
  ...
  ';
                  ...
                  try {
                      ...
                      $mail3->SMTPAuth   = true;                                  
                      $mail3->Username   = 'ticketwl@mailservice.center';                    
                      ...
                      $mail3->isHTML(true);                                  
                      $mail3->Subject = "New Ticket Issue Request rejected by $agentCompanyName";
