...
if (authorization($conn) == true){
  if (array_key_exists("all", $_GET)) {
    ...
    $totalApprovedData = $conn->query("SELECT * FROM `deposit_request` WHERE status='approved' ORDER BY id DESC")->num_rows;
    $totalPendingData = $conn->query("SELECT * FROM `deposit_request` WHERE status='pending' ORDER BY id DESC")->num_rows;
    $totalRejectedData = $conn->query("SELECT * FROM `deposit_request` WHERE status='rejected' ORDER BY id DESC")->num_rows;
    ...
    $return_arr['totalApprovedData'] = $totalApprovedData;
